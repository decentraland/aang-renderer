...
namespace DCL.Rendering.RenderGraphs.RenderFeatures.SkyboxEnvironmentProbe
{
    public class RendererFeature_SkyboxEnvironmentProbe : ScriptableRendererFeature
    {
        ...
        public override void Create()
        {
            ...
            RenderingUtils.ReAllocateHandleIfNeeded (ref skyBoxCubeMapRTHandle, desc, FilterMode.Bilinear, TextureWrapMode.Clamp, anisoLevel: 1, mipMapBias: 0F, name: "_SkyBoxCubeMapTex");
